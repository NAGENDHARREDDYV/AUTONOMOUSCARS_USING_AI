...
def azurecreate():
	...
	training_key = "putazuretrainingkeyyourkey"
	prediction_key = "putazurepredicitionkeyyourkey"
...
def azurepredict():
	...
	with open("camera_img.jpeg", mode="rb") as test_data:
		results = predictor.predict_image("projectID here please", test_data, "IterationID here please")

	# Display the results.
	for prediction in results.predictions:
		print ("\t" + prediction.tag_name + ": {0:.2f}%".format(prediction.probability * 100))
		#if(prediction.probability * 100> 45):
...
##call your recognition model here and set the value of turn
	...
	global h
	h=mypred
	print("My pred:",mypred)

	global count
	global secondright
	print(count)
	if count==0 or secondright:
		turn="left"
		count=count+1
		secondright=False
	else:
